...
def _post_pinned_comment(video_id, message, access_token, page_id):
    """Post the description (with website link) as a pinned comment on the reel."""
    import time
    print(f"[facebook] Posting pinned comment with link...")
    max_retries = 5
    comment_id = None
...
def upload_to_facebook(video_path, description, title="Monk Tashirok"):
    """
    ...
    # Append website link to the Facebook description
    fb_description = f"{description}\n\n🌐 Visit us at: https://gleku.com/tashirok"
